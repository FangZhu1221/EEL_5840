# -*- coding: utf-8 -*-
"""
Created on Mon Nov 13 14:02:25 2017
...
for j in range(4):
    ...
    if j == 1 or j == 0:
        ...
        k2 = -1
    for i in range(25):
        training[j*25+i,0]=k1*np.random.uniform(0,2)
        training[j*25+i,1]=k2*np.random.uniform(0,2)
        if k1*k2>0:
            validate[0,j*25+i]=0
        else:
            if k1*k2<0:
...
p1.scatter(training[0:25,0],training[0:25,1],c="b")
p1.scatter(training[25:50,0],training[25:50,1],c="r")
p1.scatter(training[50:75,0],training[50:75,1],c="b")
p1.scatter(training[75:100,0],training[75:100,1],c="r")
p1.plot(t,z1)
p1.plot(t,z2)
